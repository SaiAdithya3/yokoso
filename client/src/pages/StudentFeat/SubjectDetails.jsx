...
const SubjectDetails = () => {
  ...
  // Sample data for a single subject with units (chapters) and topics
  const subject = {
    id: 1,
    courseID: 'CSE101',
      ...
      <div className="w-full bg-zinc-50 p-4">
        ...
        <Breadcrumb className="hidden md:flex px-2 pt-3 pb-2">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Subject Details</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        {/* Title */}
        <h1 className="text-3xl font-semibold px-2 mb-6 border-b pb-6">Teaching Content - {subject.courseName}</h1>

        {/* Dropdown and Subject List */}
        <div className="flex w-full rounded-xl m-2 p-2 gap-3">
          ...
          <div className="flex items-center gap-5 p-6 bg-red-50 border border-red-200 rounded-xl">
            ...
            <div className="flex flex-col">
              <h2 className="text-lg font-semibold">Leacturer / Faculty</h2>
              <p className="text-sm text-gray-600">{subject.lecturer}</p>
            </div>
          </div>
